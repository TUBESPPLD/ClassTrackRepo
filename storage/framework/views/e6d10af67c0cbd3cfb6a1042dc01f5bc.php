...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Kelola Kuis - ' . $classroom->name)]); ?>
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        ...
                        <div class="space-y-3 max-h-40 overflow-y-auto pr-2">
                            <?php $__currentLoopData = $kuis->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="text-sm">
                                    <p class="font-medium text-gray-800"><?php echo e($index+1); ?>. <?php echo e($q->question_text); ?></p>
    ...
    <div id="modal-buat-kuis" class="fixed inset-0 z-50 hidden bg-gray-900/50 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
        <div class="bg-white rounded-3xl w-full max-w-2xl p-8 shadow-xl relative my-8">
            ...
            <form method="POST" action="<?php echo e(route('guru.kuis', $classroom)); ?>" x-data="{ submitting: false, questions: [ { q: '', a:'', b:'', c:'', d:'', correct:'a' } ] }" @submit="submitting = true">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/nadilla/Downloads/ClassTrackRepo-main/resources/views/kuis/index.blade.php ENDPATH**/ ?>