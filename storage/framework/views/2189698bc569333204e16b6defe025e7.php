...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Manajemen User']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Manajemen User')]); ?>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
            ...
            <span class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-bold"><?php echo e(count($users)); ?> Total Pengguna</span>
        </div>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-900 text-sm"><?php echo e($user->name); ?></p>
                            ...
                            <td class="px-6 py-4">
                                ...
                                ?>
                                <span class="px-3 py-1 rounded-full text-xs font-semibold border <?php echo e($color); ?>">
                                    <?php echo e(ucfirst($user->role)); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4">
                                <p class="text-sm text-gray-600"><?php echo e(\Carbon\Carbon::parse($user->created_at)->format('d M Y')); ?></p>
                                <p class="text-xs text-gray-400"><?php echo e(\Carbon\Carbon::parse($user->created_at)->diffForHumans()); ?></p>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <?php if($user->id !== auth()->id()): ?>
                                    <form method="POST" action="<?php echo e(route('admin.users.delete', $user)); ?>" onsubmit="return confirm('Yakin ingin menghapus pengguna ini secara permanen?');">
...
<?php endif; ?>
<?php /**PATH /Users/alvaritzymaulidan/Documents/ClassTrackRepo-main/resources/views/admin/users.blade.php ENDPATH**/ ?>