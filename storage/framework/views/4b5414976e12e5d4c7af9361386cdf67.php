        ...
        <?php $__empty_1 = true; $__currentLoopData = ($assignments ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tugas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex flex-col lg:flex-row gap-6">
                <div class="flex-1">
                    ...
                    <?php if(($tugas->questionBankReferences ?? collect())->count() > 0): ?>
                        <div class="mt-3 p-3 bg-gray-50 border border-gray-100 rounded-xl">
                            <p class="text-xs font-semibold text-gray-700">Referensi Bank Soal (<?php echo e($tugas->questionBankReferences->count()); ?>)</p>
                            <ul class="mt-2 space-y-1 text-xs text-gray-600 list-disc list-inside">
                                <?php $__currentLoopData = $tugas->questionBankReferences->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><?php echo e(\Illuminate\Support\Str::limit($ref->question_text, 120)); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                            <?php if($tugas->questionBankReferences->count() > 3): ?>
                                <p class="text-[10px] text-gray-500 mt-2">+ <?php echo e($tugas->questionBankReferences->count() - 3); ?> soal lainnya</p>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
<?php /**PATH D:\ClassTrackRepo\resources\views/tugas/index.blade.php ENDPATH**/ ?>