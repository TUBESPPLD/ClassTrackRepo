                ...
                <div class="flex-1">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <form action="{{ route('guru.kuis.delete', $kuis) }}" method="POST" id="form-delete-kuis-{{ $kuis->id }}">
                                @csrf @method('DELETE')
                                <button type="button" onclick="confirmDelete('form-delete-kuis-{{ $kuis->id }}', 'Yakin ingin menghapus kuis ini?')" class="p-1.5 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors">
