                ...
                <div x-show="type === 'mcq'" class="space-y-3">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input name="option_a" class="w-full border rounded-xl px-3 py-2 bg-gray-50" required>
                        </div>
                        <div>
                            <label class="text-xs text-gray-600 block mb-1">Opsi B</label>
                            <input name="option_b" class="w-full border rounded-xl px-3 py-2 bg-gray-50" required>
                        </div>
                        <div>
                            <label class="text-xs text-gray-600 block mb-1">Opsi C</label>
                            <input name="option_c" class="w-full border rounded-xl px-3 py-2 bg-gray-50" required>
                        </div>
                        <div>
                            <label class="text-xs text-gray-600 block mb-1">Opsi D</label>
                            <input name="option_d" class="w-full border rounded-xl px-3 py-2 bg-gray-50" required>
                        </div>
                    </div>
                    <div>
